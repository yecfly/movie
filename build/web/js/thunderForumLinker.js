...
function isSB360(){
	...
	function thunderLinker(arg1,arg2,arg3)
	{
		...
		var posStr=0;
		var thunderHref = "thunderHref";
    		if(isSB360()){
      			thunderHref = "flashHref";
    		}
...
var thunderSufix=".srt|.mkv|.jad|.bis|.bin|.sw|.reg|.sisx|.sis|.eet|.xls|.nh|.kdh|.ppt|.mdf|.wmp|.doc|.pdf|.chm|.asf|.avi|.exe|.iso|.mp3|.mpeg|.mpg|.mpga|.ra|.rar|.rm|.rmvb|.tar|.wma|.wmv|.zip|.swf|.mp4|.3gp|.torrent|.txt|.jar|.mov|.wav|.eip";
